        ...
        <>
            ...
            >
                <div className="container mx-auto flex h-14 items-center px-4 md:px-6">
                    ...
                    {/* Desktop nav */}
                    <nav className="ml-auto hidden md:flex gap-1 sm:gap-2 text-sm font-medium">
                        {navItems.map((item, i) => {
            ...
            <AnimatePresence>
                {mobileMenuOpen && (
                    ...
                    >
                        ...
                        {/* Menu panel */}
                        <motion.nav
                            className="absolute top-14 left-0 right-0 bg-card border-b border-border/50 shadow-2xl"
